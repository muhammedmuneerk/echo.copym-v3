...
import GlobalCarbonCreditsMarketDashboard from "./GlobalCarbonCreditsMarketDashboard";
    ...
    <div className="min-h-screen relative text-white">
      ...
      <section id="hero" className="relative min-h-[90vh] flex items-center">
        <div className="container mx-auto px-4 py-20 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            ...
            >
              <img
                src="/assets/sections/carbon-credits-market.png"
                alt="Carbon Credits Market"
      ...
      <section id="analytics" className="py-16">
        <div className="container mx-auto px-4">
            ...
            >
              ...
              >
                ...
                <Box className="hidden lg:block">
                  <GradientLetters
                    text="Live Carbon Credits Market Analytics"
                    keyPrefix="lg-line1"
                  />
                </Box>
                ...
                <Box className="block lg:hidden">
                  <GradientLetters
                    text="Live Carbon Credits Market"
                    keyPrefix="sm-line1"
                  />
                </Box>
                <Box className="block lg:hidden">
          ...
          <GlobalCarbonCreditsMarketDashboard />
        </div>
      </section>
      ...
      <section id="portfolio" className="py-16 ">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto mb-12 text-center">
            ...
            >
              ...
              >
                ...
                <Box className="hidden lg:block">
                  <GradientLetters
                    text="Optimize Your Carbon Credits Portfolio"
                    keyPrefix="lg-line1"
                  />
                </Box>
                ...
                <Box className="block lg:hidden">
                  <GradientLetters text="Carbon Credits Portfolio" keyPrefix="sm-line1" />
                </Box>
              </Box>
            </Typography>
          ...
          <CarbonCreditsPortfolioAllocation />
        </div>
      </section>
          ...
          <div className="max-w-4xl mx-auto mb-12 text-center">
            ...
            >
              ...
              >
                ...
                <Box className="hidden lg:block">
                  <GradientLetters
                    text="Carbon Credits Investment Calculator"
                    keyPrefix="lg-line1"
                  />
                </Box>
          ...
          <div className="max-w-4xl mx-auto mb-12 text-center">
            ...
            >
              ...
              >
                ...
                <Box className="hidden lg:block">
                  <GradientLetters
                    text="Find Carbon Credits Investment Opportunities"
                    keyPrefix="lg-line1"
                  />
                </Box>
...
export default CarbonCreditsMarket;
